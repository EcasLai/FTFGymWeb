<%@ Page Title="Equipment Product | FTF Gym Web" Language="C#" MasterPageFile="~/Gym.Master" AutoEventWireup="true" CodeBehind="EquipmentProductList.aspx.cs" Inherits="GymWeb.EquipmentProductList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [Product] WHERE CategoryId=3">
    </asp:SqlDataSource>
</asp:Content>